...
# Fix old Keras model compatibility
with h5py.File("keras_model.h5", mode="r+") as f:
    ...
    # Remove unsupported groups parameter
...
if file is None:
    ...
    class_name, confidence_score = import_and_predict(file, model)

    st.subheader("Prediction")
    st.write(class_name[2:])

    st.subheader("Confidence Score")
    st.write(f"{confidence_score * 100:.2f}%")
